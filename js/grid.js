...
arcade.minesweeper.grid.prototype.revealed_tiles;
arcade.minesweeper.grid.prototype.number_tiles;


arcade.minesweeper.grid.prototype.generate = function (number_mines, seed) {
    var self = this;

    this.number_tiles = this.width * this.height;
    ...
    var i = this.number_tiles - number_mines;
    while (i--) {
...
arcade.minesweeper.grid.prototype.reveal_area = function (x, y) {
    var self = this;
    const tile_revealed = this.tiles[x][y].is_revealed();
    if (!tile_revealed) {
        this.revealed_tiles++;
    }
